...
def crslt_info():
    return {"text": "*КАРОЧЄ ТУТ ІНФА ПРО КРОССЛЕТТЕРІНГ, ВОЛОДАРЮ*"}


def crslt_description():
    return {"text": "Наступним повідомленням відправ всю інфу, за якою можна тебе знайти або надіслати тобі листа:"
                    "адресу, інст, телефон, постове відділення, ПІБ"}
